...
export const INSTANTCOIN = new Asset({
    ...
    reissuable: true,
    precision: 2,
    description: 'INSTANTCOIN a token that is been build on the Acryl platform. Subscribe on the website & social media for more upcoming updates.',
    height: 851542
});
...
export const Beatz = new Asset({
    ...
    reissuable: false,
    precision: 8,
    description: 'Beatz by acryl will contribute to the future of Web 3.0 by building a decentralized music platform allowing all users from across the globe to publish their music whether your at home in your shower or a world class music studio you can publish your music and allow users from around the world to purchase it via Beatz by acryl .',
    height: 1538724
});
