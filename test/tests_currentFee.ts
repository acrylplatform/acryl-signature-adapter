...
import { seedUtils } from '@acryl/acryl-transactions';
import { Signable, currentCreateOrderFactory, SeedAdapter, TSignData, SIGN_TYPE } from '../src';
import { IExchangeTransactionOrder } from '@acryl/ts-types';
...
const TEST_LIST: Array<ITestItem> = [
    {
        data: {
            ...
            data: {
                timestamp: Date.now(),
                fee: new Money(CONFIG.calculate_fee_rules.default.fee, ACRYL_ASSET),
    ...
    },
    {
        data: {
            ...
            data: {
                timestamp: Date.now(),
                fee: new Money(CONFIG.calculate_fee_rules['3'].fee, ACRYL_ASSET),
                name: 'My Asset',
    ...
    },
    {
        data: {
            ...
            data: {
                ...
                fee: new Money(CONFIG.calculate_fee_rules['5'].fee, ACRYL_ASSET),
                quantity: new BigNumber(500),
                reissuable: true
            }
        },
