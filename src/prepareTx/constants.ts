...
import * as acrylTransactions from '@acryl/acryl-transactions';
import { toNode as mlToNode } from '@acryl/money-like-to-node';
...
export const SIGN_TYPES: Record<SIGN_TYPE, ITypesMap> = {
    ...
    [SIGN_TYPE.CREATE_ORDER]: {
        ...
        toNode: data => {
            ...
            return toNode(data, acrylTransactions.order);
        },
        adapter: 'signOrder'
    },
    ...
    [SIGN_TYPE.REISSUE]: {
        ...
        toNode: data => {
            ...
            return toNode({ ...data, quantity }, acrylTransactions.reissue);
        },
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.BURN]: {
        ...
        toNode: data => {
            const quantity = data.amount || data.quantity;
            return toNode({ ...data, quantity }, acrylTransactions.burn);
        },
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.EXCHANGE]: {
        ...
        toNode: data => {
            ...
            return acrylTransactions.exchange({ ...tx, order1, order2 });
        },
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.LEASE]: {
    ...
    [SIGN_TYPE.CANCEL_LEASING]: {
        ...
        toNode: data => toNode(data, acrylTransactions.cancelLease),
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.CREATE_ALIAS]: {
        ...
        toNode: data => ({ ...toNode(data, acrylTransactions.alias), chainId: data.chainId }),
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.MASS_TRANSFER]: {
        ...
        toNode: (data, networkByte: number) => (toNode({
            ...
            attachment: processors.attachment(data.attachment)
        }, acrylTransactions.massTransfer)),
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.DATA]: {
        getBytes: {
        ...
        toNode: data => toNode(data, acrylTransactions.data),
        adapter: 'signTransaction'
    },
    ...
    [SIGN_TYPE.SPONSORSHIP]: {
        ...
        toNode: data => toNode(data, acrylTransactions.sponsorship),
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.SET_ASSET_SCRIPT]: {
        ...
        toNode: data => toNode({
            ...
            acrylTransactions.setAssetScript,
        ),
        adapter: 'signTransaction'
    },
    [SIGN_TYPE.SCRIPT_INVOCATION]: {
        ...
        }, acrylTransactions.invokeScript)),
        adapter: 'signTransaction'
    },
};
